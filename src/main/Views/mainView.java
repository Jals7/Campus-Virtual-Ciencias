...
public class mainView extends JFrame implements ActionListener{
    ...
    mainView(){
        ...
        newEvent = new JButton("Crear evento");
        newEvent.setFont(new Font("Roboto", 1, 14));
        newEvent.setBounds(80, 350, 140, 30);
        newEvent.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
        newEvent.addActionListener(this);
        rightPanel.add(newEvent);

        goToEvents = new JButton("Ir a eventos proximos");
        goToEvents.setFont(new Font("Roboto", 1, 14));
        goToEvents.setBounds(50, 450, 200, 30);
        goToEvents.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
        goToEvents.addActionListener(this);
        rightPanel.add(goToEvents);
