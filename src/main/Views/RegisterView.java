...
public class RegisterView extends JFrame implements ActionListener, ItemListener {
    ...
    private JTextField txtNombre, txtApellido, txtFechaNacimiento, txtEdad, txtSexo, txtCI, txtCorreo;
    ...
    public RegisterView() {
        ...
        // Crear un panel principal con fondo azul
        ...
        mainPanel.add(carreraLabel);
        txtCarrera = new JTextField();
        txtCarrera.setBounds(750, 100, 200, 30);
        mainPanel.add(txtCarrera);
    ...
    if (labelText.contains("Contraseña")) {
        textField = new JPasswordField(); // Cambiar a JPasswordField para la contraseña
    } else {
    ...
    else if (labelText.contains("Contraseña")) txtContrasena = (JPasswordField) textField;
}
...
public void actionPerformed(ActionEvent ae) {
    if (ae.getSource() == registerButton) {
        ...
        if (RegisterController.Register(id, nombre, apellido, fechaNacimiento, edad, sexo, CI, correo, contrasena, carrera, anioDeIngreso, escuela, materiaDada, cargo)) {
